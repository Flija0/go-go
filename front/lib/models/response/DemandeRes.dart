...
List<DemandeRes> demandeResFromJson(String str) => List<DemandeRes>.from(json.decode(str).map((x) => DemandeRes.fromJson(x)));

String demandeResToJson(List<DemandeRes> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class DemandeRes {
  ...
  factory DemandeRes.fromJson(Map<String, dynamic> json) => DemandeRes(
    id: json["id"],
    status: json["status"],
